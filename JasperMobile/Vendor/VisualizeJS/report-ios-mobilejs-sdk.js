...
(function() {
  ...
  define('js.mobile.ios.report.callback', ['require','js.mobile.callback_dispatcher'],function(require) {
    ...
    return ReportCallback = (function(superClass) {
      ...
      ReportCallback.prototype.onPageChange = function(page) {
        this.dispatch(function() {
          return this._makeCallback("reportOnPageChange&page=" + page);
        });
      };
      ...
      ReportCallback.prototype.logMessage = function(message) {
        return this.dispatch(function() {
          return this._makeCallback("logMessage&message=" + message);
        });
      };
...
(function() {
  ...
  define('js.mobile.report.controller', ['require','jquery','js.mobile.lifecycle','js.mobile.module'],function(reqiure) {
    ...
    return ReportController = (function(superClass) {
      ...
      ReportController.prototype._fitReport = function(fitParameter) {
        this.callback.logMessage("_fitReport");
        return this.report.scale(fitParameter).render();
      };
...
(function() {
  ...
  define('js.mobile.report', ['require','js.mobile.session','js.mobile.report.controller','js.mobile.scale.manager','js.mobile.lifecycle','js.mobile.module'],function(require) {
    ...
    MobileReport = (function(superClass) {
      ...
      MobileReport.fitReport = function(fitParameter) {
        return this._instance._fitReport(fitParameter);
      };
      ...
      function MobileReport(args) {
        this._fitReport = bind(this._fitReport, this);
        this._getChartTypeList = bind(this._getChartTypeList, this);
      ...
      MobileReport.prototype._fitReport = function(fitParameter) {
        return this._controller._fitReport(fitParameter);
      };

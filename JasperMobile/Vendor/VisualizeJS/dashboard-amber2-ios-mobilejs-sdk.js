...
(function() {
  define('js.mobile.amber2.dashboard', ['require','js.mobile.amber2.dashboard.controller','js.mobile.session'],function(require) {
    var DashboardController, MobileDashboard, Session, root;

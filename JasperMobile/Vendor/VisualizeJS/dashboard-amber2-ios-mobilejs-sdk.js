...
(function() {
  ...
  define('js.mobile.amber2.dashboard.controller', ['require','jquery'],function(require) {
...
(function() {
  define('js.mobile.amber2.dashboard', ['require','js.mobile.amber2.dashboard.controller','js.mobile.session','js.mobile.scaler'],function(require) {
    var DashboardController, MobileDashboard, Scaler, Session, root;
...
(function() {
  require(['js.mobile.amber2.ios.dashboard.client'], function(DashboardClient) {
    return new DashboardClient().run();
  });

}).call(this);

define("ios/amber2/dashboard/main.js", function(){});

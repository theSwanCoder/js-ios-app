...
/**
 ...
 @since 1.0
 */
@interface JSUIReportUnitViewController : UIViewController  <JSRequestDelegate, UIScrollViewDelegate, UIWebViewDelegate, NSURLConnectionDelegate, NSURLConnectionDataDelegate> {
	// Execution id
	NSString *uuid;
	NSInteger pages;

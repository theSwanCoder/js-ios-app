...
NSString * const kJMPageAccessibilityIdKey = @"accessibilityIdKey";
...
NSString *const JMResourceCollectionPageListRepresentationButtonViewPageAccessibilityId = @"JMResourceCollectionPageListRepresentationButtonViewPageAccessibilityId";
NSString *const JMResourceCollectionPageGridRepresentationButtonViewPageAccessibilityId = @"JMResourceCollectionPageGridRepresentationButtonViewPageAccessibilityId";
...
NSString *const JMResourceInfoPageDescriptionLabelAccessibilityId = @"JMResourceInfoPageDescriptionLabelAccessibilityId";
NSString *const JMResourceInfoPageTypeLabelAccessibilityId = @"JMResourceInfoPageTypeLabelAccessibilityId";
NSString *const JMResourceInfoPageUriLabelAccessibilityId = @"JMResourceInfoPageUriLabelAccessibilityId";
NSString *const JMResourceInfoPageVersionLabelAccessibilityId = @"JMResourceInfoPageVersionLabelAccessibilityId";
NSString *const JMResourceInfoPageCreationDateLabelAccessibilityId = @"JMResourceInfoPageCreationDateLabelAccessibilityId";
NSString *const JMResourceInfoPageModifiedDateLabelAccessibilityId = @"JMResourceInfoPageModifiedDateLabelAccessibilityId";
NSString *const JMResourceInfoPageFormatLabelAccessibilityId = @"JMResourceInfoPageFormatLabelAccessibilityId";

...
- (void)createItemsArray
{
    ...
    @[@{@"title" : JMCustomLocalizedString(@"detail.settings.item.server", nil), @"value" : serverString, @"cellIdentifier" : kJMServerCellIdentifier},
      ...
      @{@"title" : JMCustomLocalizedString(@"detail.settings.item.intro", nil), @"value" : @"", @"cellIdentifier" : kJMIntroCellIdentifier},
      @{@"title" : JMCustomLocalizedString(@"detail.settings.feedback", nil), @"value" : @"", @"cellIdentifier" : kJMFeedbackCellIdentifier}];

    ...
    switch (option) {
        ...
        case JMResourcesListLoaderOption_Filter: {
            NSMutableArray *itemsArray = [@[
                                            ...
                                            @{kJMResourceListLoaderOptionItemTitleKey: JMCustomLocalizedString(@"resources_filterby_type_saved_reportUnit", nil),
                                              kJMResourceListLoaderOptionItemValueKey: @[kJMSavedReportUnit]},
                                            @{kJMResourceListLoaderOptionItemTitleKey: JMCustomLocalizedString(@"resources_filterby_type_folder", nil),
                                              kJMResourceListLoaderOptionItemValueKey: @[kJS_WS_TYPE_FOLDER]},
                                            @{kJMResourceListLoaderOptionItemTitleKey: JMCustomLocalizedString(@"resources_filterby_type_files", nil),

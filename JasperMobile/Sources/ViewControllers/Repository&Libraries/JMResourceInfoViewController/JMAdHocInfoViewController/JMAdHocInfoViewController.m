...
//
//  JMAdHocInfoViewController.m
//  TIBCO JasperMobile
//

#import "JMAdHocInfoViewController.h"
...
@implementation JMAdHocInfoViewController
...
- (void)runReport
{
    ...
    if (nextVC) {
        JMAdHocViewerVC *adHocViewerVC = (JMAdHocViewerVC *)nextVC;

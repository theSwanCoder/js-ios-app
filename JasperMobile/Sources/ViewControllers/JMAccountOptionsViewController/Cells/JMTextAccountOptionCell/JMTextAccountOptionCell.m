...
#import "JMTextAccountOptionCell.h"
#import "UITableViewCell+Additions.h"
#import "JMTextField.h"
#import "UIColor+RGBComponent.h"


@interface JMTextAccountOptionCell () <UITextFieldDelegate>
@property (weak, nonatomic) IBOutlet JMTextField *textField;

@end

@implementation JMTextAccountOptionCell
- (void)awakeFromNib
{
    [super awakeFromNib];
...
-(void)setAccountOption:(JMAccountOption *)accountOption
{
    ...
    self.textField.text = accountOption.optionValue;
    ...
    NSString *trimmedPlaceholderString = [accountOption.titleString stringByTrimmingCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@" *"]];
...
{
    self.accountOption.optionValue = textField.text ? : nil;

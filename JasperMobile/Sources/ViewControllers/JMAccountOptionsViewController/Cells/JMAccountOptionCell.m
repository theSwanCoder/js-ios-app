...
@interface JMAccountOptionCell ()
@property (nonatomic, weak) IBOutlet UILabel *titleLabel;
@property (nonatomic, weak) IBOutlet UILabel *errorLabel;

@end

@implementation JMAccountOptionCell
...
-(void)setAccountOption:(JMAccountOption *)accountOption
{
    ...
    self.titleLabel.text = accountOption.titleString;
    [self updateDisplayingOfErrorMessage];
}

- (void) updateDisplayingOfErrorMessage
{
    self.errorLabel.text = self.accountOption.errorString;
    [UIView beginAnimations:nil context:nil];
    self.errorLabel.alpha = (self.accountOption.errorString.length == 0) ? 0 : 1;

...
NSString * const kJSEncryptionManagerAuthenticationTag = @"TIBCO.JasperServer.Authentication";
...
@implementation JSEncryptionManager (Helpers)
...
- (NSString *)encryptText:(NSString *)text withModulus:(NSString *)modulus exponent:(NSString *)exponent
{
    ...
    publicKeyRef = [self addSecKeyWithData:publicKeyData tagName:kJSEncryptionManagerAuthenticationTag];

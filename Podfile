...
abstract_target 'AppPods' do
	...
	pod 'JaspersoftSDK', :git => 'https://github.com/Jaspersoft/js-ios-sdk.git',  :branch => 'other_improvements', :subspecs => ['JSCore', 'JSSecurity', 'JSReportExtention', 'JSDashboardExtention']
